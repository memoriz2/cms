  ...
  const fetchVideos = async () => {
    try {
      const response = await axios.get(
        `${API_ENDPOINTS.VIDEOS}?page=${currentPage - 1}&size=${itemsPerPage}`
      );
              ...
              {editMode ? (
                ...
                <>
                  ...
                  <div className="video-meta">
                    <span>
                      상태: {selectedVideo.isActive ? "활성" : "비활성"}
                    </span>
                    <div className="video-meta-row">
                      ...
                      <span>
                        수정일:{" "}
                        {new Date(selectedVideo.updatedAt).toLocaleDateString()}
                      </span>
                    </div>
                    <div className="video-edit-iframe">
                      <div
        ...
        <article>
          <form onSubmit={handleSubmit}>
            <fieldset>
              ...
              <div>
                <label htmlFor="youtubeUrl">YouTube iframe 코드</label>
                <textarea
                  id="youtubeUrl"
                  name="youtubeUrl"
